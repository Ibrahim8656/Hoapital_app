...
import '../../doctor_ui/doctor_profile/docprofile_patientview.dart';
import '../../doctor_ui/doctor_profile/profile_of_doctor.dart';
import '../medicalscreen/MydoctorScreen.dart';
                      ...
                      builder: (BuildContext context) {
                        return Container(
                          ...
                          child:GestureDetector(
                            onTap: (){
                             navigator(Doctor_profile_patientView(docId: i['id'],), context);
                            },
                            child: Padding(

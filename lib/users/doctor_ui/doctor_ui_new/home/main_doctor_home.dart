...
import 'package:hosptial_project/class/cubit/get_data_cubit.dart';
...
class MainHomeDoctor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => GetDataCubit()..getDoctorData(),
      child: BlocBuilder<CubitDoctorHosptial, DoctorStates>(

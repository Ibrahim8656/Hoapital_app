...
// import 'package:hosptial_project/users/doctor_ui/dochome/patient_profile_docview.dart';
...
//                           child: InkWell(onTap: (){
//                             Constants.patientId=Booking_patients['time_slots'][index]['patient_id'];
//                             navigator(patientProfile(patientId: '${Booking_patients['time_slots'][index]['patient_id']}',), context);
//                           },
//                             child: CircleAvatar(
//                               radius: 35,
//                               child: ClipOval(
